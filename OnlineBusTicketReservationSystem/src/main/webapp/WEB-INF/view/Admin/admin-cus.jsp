...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/styles/Admin/admin-cus.css" />
  </head>
  <body>
    ...
    <main id="cust-view">
      ...
      <div class="recent-reservations table-bus">
        <h2 class="recent-tickets">Customer History</h2>
        <table class="main-table" id="cus-table">
          <thead>
            <tr>
              <th>Full Name</th>
              <th>Email</th>
          ...
          <c:forEach var="customer" items="${custList}">
            <tr>
              ...
              <td>
               <a href="${pageContext.request.contextPath}/admin-delete-customer?id=${customer.cust_id}" class="dlt-a-tag" onclick="return confirm('Are you sure?')">
