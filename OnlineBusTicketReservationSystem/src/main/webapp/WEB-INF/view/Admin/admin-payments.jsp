...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/styles/Admin/admin-payments.css" />
  </head>
  <body>
    ...
    <!-- ////// main/////// -->
    <main id="payment-view">
      <div class="payment-header">
        <h1>View Payments</h1>
        <div class="search-bar">
          <input type="text" onkeyup="searchCustomer()" placeholder="Search customer..." id="search-bar" />
      ...
      <div class="recent-reservations table-bus">
        <h2 class="recent-tickets">Payments History</h2>
        <table class="main-table" id="payment-table">
          <thead>
            <tr>
              <th>Payment Id</th>
              <th>Booking Id</th>
          ...
          <c:forEach var="payments" items="${paymentsList}">
            <tr>
              ...
              <td>${payments.booking.bookingId}</td>
              <td>${payments.cust.fullName}</td>
              <td>${payments.amount }</td>
              <td class="payment-status ${payments.paymentStatus}">${payments.paymentStatus }</td>
