...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/styles/Admin/admin-booking.css"/>
  </head>
  <body>
    ...
    <main id="tickets-view">
      ...
      <div class="recent-reservations table-bus">
        <h2 class="recent-tickets">Tickets History</h2>
        <table class="main-table" id="booking-table">
          <thead>
            <tr>
              <th>Full Name</th>
              <th>Phone number</th>
            ...
            <tr>
        	 ...
        	 <td>${booking.totalPrice}</td>
              ...
              <td>
                  ...
                  <a href="${pageContext.request.contextPath}/admin-delete-booking?id=${booking.bookingId}" class="dlt-a-tag" onclick="return confirm('Are you sure?')">
