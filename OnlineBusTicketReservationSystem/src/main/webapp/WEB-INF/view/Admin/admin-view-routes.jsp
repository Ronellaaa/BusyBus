...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/styles/Admin/admin-view-routes.css" />
  </head>
  <body>
    ...
    <main id="routes-view">
      <div class="add-routes-div">
          ...
          <h1>Add Routes</h1>
          <a href="${pageContext.request.contextPath}/admin-add-routes"><button class="add-route-btn">+ Add Route</button></a>
      ...
      <div class="routes-header">
        ...
        <div class="search-bar">
          <input type="text" onkeyup="searchRoute()" placeholder="Search routes..." id="search-bar" />
      ...
      <div class="recent-reservations table-bus">
        <h2 class="recent-tickets">Routes History</h2>
        <table class="main-table" id="routes-table">
          <thead>
            <tr>
              <th>Route Id</th>
              <th>Route Name</th>
            <!--   <th>Available Bus Operators</th> -->
              <th>Actions</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
             ...
             <!--  <td>Action</td> -->
              <td>
                ...
                <a href="${pageContext.request.contextPath}/admin-delete-routes?id=${route.routeId}" class="dlt-a-tag" onclick="return confirm('Are you sure?')">
                ...
                <a href="${pageContext.request.contextPath}/admin-edit-routes?id=${route.routeId}">
