  ...
  <body>
    ...
    <main id="routes-view">
      <div class="add-routes-div">
        ...
        <form action="${pageContext.request.contextPath}/admin-edit-routes" method="post" class="route-form">
          <h1>Edit Routes</h1>
          <div class="form-group">
            <label for="route-id">Route Id</label>
            <input type="text" name="id" id="route-id"  value="${route.routeId}" readonly/>
          </div>
          <div class="form-group">
          ...
          <input type="submit" value="Edit Route" class="add-route-btn" />
        </form>
      </div>
