...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/styles/Admin/admin-add-ticket.css"/>
  ...
  <body>
   ...
   <main class="admin-add-bus-container">
    <h1 class="addBusHeading">Assign Buses to Routes</h1>
    <div class="admin-add-bus-div">
      <div class="form-card">
        <div class="add-bus-img">
       
           <img src="./assets/bus2.png" alt="Bus Illustration" /> 
        </div>
        <form action="${pageContext.request.contextPath}/admin-add-ticket" method="post" class="add-bus-form">
          <div class="form-row">
            <div class="form-group">
              <label for="bus-name">Bus Name</label>
              <select id="bus-name" name="busname" required>
                <option value="" disabled selected>Select a bus name</option>
                <c:forEach var="busName" items="${busName }">
            ...
            <div class="form-group">
              ...
              <select id="bus-type" name="bustype" required>
            ...
            <div class="form-group">
              ...
              <input type="number" id="total-seats" name="totalSeats" readonly />
            </div>
          </div>
            ...
            <div class="form-group">
              ...
              <select id="status" name="status" required>
                <option value="" disabled selected>Select status</option>
                  <c:forEach var="status" items="${busStatuses}">
          ...
          <div class="form-actions">
            ...
            <button type="submit" class="add-bus-btn">Add Bus</button>
          </div>
        </form>
      </div>
    </div>
 ...
 <script>
  ...
  const buses = [
    <c:forEach var="bus" items="${busList}" varStatus="loop">
      {
  ...
  <script src="${pageContext.request.contextPath}/js/Admin/admin-add-ticket.js"></script>
