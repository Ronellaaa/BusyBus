  ...
  <body>
    ...
    <main>
      ...
      <div class="dashboard-cards">
        <div class="card custCard">Customers: ${totalCustomers}</div>
        <div class="card busOpCard">Bus Operators: ${totalBusOperators}</div>
        <div class="card seatCard">Total Seats: ${totalSeats}</div>
        <div class="card paymentCard">Total Payments: Rs. ${totalPayments}</div>
      </div>
        ...
        <div class="recent-busOperators table-bus">
          ...
          <table>
            ...
            <c:forEach var="adminBus" items="${adminBus }">
              ...
              <td class="${adminBus.bus.is_active ? 'active' : 'inactive'}">
          ...
          <table>
            ...
            <c:forEach var="adminRoutes" items="${adminRoutes }">
              <tr>
                ...
                <td class="busType ${fn:replace(adminRoutes.bus.bus_type, ' ', '-')}">${adminRoutes.bus.bus_type }</td>
